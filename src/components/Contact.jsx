export default function () {
    ...
    return (
        <div className="flex flex-col items-center justify-center">
            <div className="flex items-center gap-2 w-xl h-10 border-x border-t mt-4 border-white/50 rounded-t-xl">
            ...
            <div className="w-xl h-100 border border-white/50 rounded-b-xl p-4 text-sm  font-fira-code">
